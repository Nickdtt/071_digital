...
export default function AboutUs() {
    return (
        <div className="bg-[#F2FBEE] w-full h-[100vh] flex flex-col justify-center items-center lg:flex-row-reverse lg:justify-between lg:items-center  px-[100.23px] py-[62.82px]" >
